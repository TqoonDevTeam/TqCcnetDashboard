...
'controller/project/modules/svc'], function (app, guid, URI) {
    ...
    app.controller('project.step5.ctrl', ['$scope', '$uibModal', 'pathUtil', function ($scope, $uibModal, pathUtil) {
        this.getDesc = function (item) {
            return (publishersDesc[item['@type']] || publishersDesc['default'])(item);
        }
        ...
        this.onPubAddClick = function () {
            var instance = $uibModal.open({
                templateUrl: pathUtil.GetTemplate('/project/step5/publishers.add.tmpl.html'),
                controller: 'project.step5.publishers.add.ctrl',
                controllerAs: 'ctrl',
                scope: $scope,
